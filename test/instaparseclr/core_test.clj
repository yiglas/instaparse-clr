(ns instaparseclr.core-test
  (:refer-clojure :exclude [cat])
  (:use clojure.test)
  (:require clojure.edn)
  (:require [instaparseclr.core :as insta]) 
  (:require [instaparseclr.line-col :as lc])
...
(deftest line-col-test
  (let [text1 "abc\ndef\ng\nh\ni",
    ...
    (is (= (enlive-line-col-spans elc)
           '({:instaparseclr.gll/end-column 2, :instaparseclr.gll/end-line 5, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 1, :instaparseclr.gll/start-index 0, :instaparseclr.gll/end-index 13} ({:instaparseclr.gll/end-column 4, :instaparseclr.gll/end-line 1, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 1, :instaparseclr.gll/start-index 0, :instaparseclr.gll/end-index 3} "a" "b" "c") ({:instaparseclr.gll/end-column 4, :instaparseclr.gll/end-line 2, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 2, :instaparseclr.gll/start-index 4, :instaparseclr.gll/end-index 7} "d" "e" "f") ({:instaparseclr.gll/end-column 2, :instaparseclr.gll/end-line 3, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 3, :instaparseclr.gll/start-index 8, :instaparseclr.gll/end-index 9} "g") ({:instaparseclr.gll/end-column 2, :instaparseclr.gll/end-line 4, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 4, :instaparseclr.gll/start-index 10, :instaparseclr.gll/end-index 11} "h") ({:instaparseclr.gll/end-column 2, :instaparseclr.gll/end-line 5, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 5, :instaparseclr.gll/start-index 12, :instaparseclr.gll/end-index 13} "i"))))           
    (is (= (hiccup-line-col-spans hlc)
           '({:instaparseclr.gll/end-column 2, :instaparseclr.gll/end-line 5, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 1, :instaparseclr.gll/start-index 0, :instaparseclr.gll/end-index 13} ({:instaparseclr.gll/end-column 4, :instaparseclr.gll/end-line 1, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 1, :instaparseclr.gll/start-index 0, :instaparseclr.gll/end-index 3} "abc") ({:instaparseclr.gll/end-column 4, :instaparseclr.gll/end-line 2, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 2, :instaparseclr.gll/start-index 4, :instaparseclr.gll/end-index 7} "def") ({:instaparseclr.gll/end-column 2, :instaparseclr.gll/end-line 3, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 3, :instaparseclr.gll/start-index 8, :instaparseclr.gll/end-index 9} "g") ({:instaparseclr.gll/end-column 2, :instaparseclr.gll/end-line 4, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 4, :instaparseclr.gll/start-index 10, :instaparseclr.gll/end-index 11} "h") ({:instaparseclr.gll/end-column 2, :instaparseclr.gll/end-line 5, :instaparseclr.gll/start-column 1, :instaparseclr.gll/start-line 5, :instaparseclr.gll/start-index 12, :instaparseclr.gll/end-index 13} "i"))))))
